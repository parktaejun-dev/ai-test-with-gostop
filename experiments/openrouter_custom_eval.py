...
def run_custom_eval(
    ...
    *,
    ...
    bundle = export_experiment_bundle(
        output_dir,
        config={
            "experiment": "openrouter_custom_eval",
...
def _parse_args():
    parser = argparse.ArgumentParser(description="Run fixed OpenRouter model evaluations.")
...
def main() -> None:
    ...
    output_dir = args.output_dir or _default_output_dir("openrouter_custom")
